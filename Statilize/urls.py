...
urlpatterns = [
    ...
    path('game/<game_id>/edit_player_game/<uuid:player_id>', edit_player_game, name='edit_player_game'),
    path('game/<game_id>/edit_pitcher_game/<uuid:pitcher_id>', edit_pitcher_game, name='edit_pitcher_game'),
]
