# Generated by Django 5.1.2 on 2024-11-23 03:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pitcher_year', models.CharField(choices=[('FR', 'Freshman'), ('SO', 'Sophomore'), ('JR', 'Junior'), ('SR', 'Senior'), ('N/A', 'Unspecified')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player_year', models.CharField(choices=[('FR', 'Freshman'), ('SO', 'Sophomore'), ('JR', 'Junior'), ('SR', 'Senior'), ('N/A', 'Unspecified')], max_length=3)),
        ...
        migrations.AddField(
            model_name='game',
            name='winner',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='statalize_app.team'),
        ),
    ]
